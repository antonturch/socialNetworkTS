...
import {AuthStateType, getLoginThunk, logOutThunks} from "../../redux/auth-reducer";
...
//     }
// )
export const HeaderConnect = connect(mapStateToProps, {getLoginThunk, logOutThunks})(HeaderContainer)